...
exports.SESSION_MAX_AGE = env('SESSION_MAX_AGE', 24 * 60 * 60 * 1000);
...
exports.DEFAULT_CACHE_TTL = env('DEFAULT_CACHE_TTL', 300);
exports.CACHE_CHECK_PERIOD = env('CACHE_CHECK_PERIOD', 60 * 1000);

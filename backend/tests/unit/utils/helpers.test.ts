  ...
  describe('Helper Utilities', () => {
    ...
    describe('getNotifications', () => {
      ...
      test('should fetch notifications from cache for authenticated user', async () => {
        ...
        (cache.getOrExecute as jest.Mock).mockResolvedValue(mockNotifications);
    ...
    describe('getNewRequestsCount', () => {
      test('should return count of new requests', async () => {
        (cache.getOrExecute as jest.Mock).mockImplementation((key, fn) => fn());
        (prisma.contactRequest.count as jest.Mock).mockResolvedValue(5);
    ...
    describe('truncateHtml', () => {
      test('should truncate string to specified length', () => {
        ...
        expect(truncated).toBe('This is a v...');
      });

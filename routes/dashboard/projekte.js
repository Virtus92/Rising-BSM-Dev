...
router.post('/:id/update-status', isAuthenticated, async (req, res) => {
  try {
   ...
   `);
    ...
    res.render('dashboard/projekte/edit', {
      ...
      projekt: {
        ...
        titel: projekt.titel,
        kunde_id: projekt.kunde_id,
        start_datum: format(new Date(projekt.start_datum), 'yyyy-MM-dd'),
        end_datum: projekt.end_datum ? format(new Date(projekt.end_datum), 'yyyy-MM-dd') : '',

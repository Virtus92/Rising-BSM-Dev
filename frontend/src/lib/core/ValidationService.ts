...
import { 
  ...
  ValidationOptions,
  ValidatorFunction
} from '@/types/interfaces/IValidationService';
import { ILoggingService } from '@/types/interfaces/ILoggingService';
import { IErrorHandler, ValidationError } from '@/types/interfaces/IErrorHandler';
...
export class ValidationService implements IValidationService {
   ...
   * @param errorHandler - Error handler for throwing validation errors
   */
  constructor(
    ...
    if (data === null || data === undefined) {
      ...
      if (opts.throwOnError) {
        if (this.errorHandler) {
          throw this.errorHandler.createValidationError('Validation failed: Data is null or undefined');
        } else {
